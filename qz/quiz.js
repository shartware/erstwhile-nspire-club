...
{
     question: "The reason than some ethnic groups are responsible for more crime is due to discrimination, but the reason that males are responsible for more crime is due to their innate tendencies toward violence",
...
{
     question: "We are living in a better world than we were 50 years ago",
...
{
     question: "Communism, if implemented correctly, is not incompatible with a free and democratic society.",
...
{
     question: "I support a store’s right to not permit a black person to shop there on the ground of religious belief",
...
function displayAnswers() {
    ...
    if (fracLA<0) {
      fracLA = -1 * Math.pow(Math.abs(fracLA), 0.6)
    }
    ...
    if (fracLR<0) {
        fracLR = -1 * Math.pow(Math.abs(fracLR), 0.6)
    }
